...
export default function My_transportations() {
  ...
  const getData = () => {
    ...
    axios.get(`http://localhost:9000/volunteer/myservices/${userdetails.email}`)
      .then((resp) => {
                ...
                donations.length > 0 ?
                          ...
                          <div className="card" style={{ borderRadius: '7px', marginBottom: '15px' }}>
                            <div className="card-body">
                              ...
                              <div>
                                ...
                                {/* <div>
                                  <button className='btn btn-secondary' onClick={(e) => { SubmitRequest(data._id,data.email) }}>Assign</button>
                                </div> */}
                              </div>
                              <br />
                            </div>
                  ...
                  <div>
                    <div className='jumbotron'>
                      ...
                      No Transportation has been done
                    </div>
                  </div>
              }
